...
import com.runicrealms.menus.animation.MultiMenuAnimation
import java.util.LinkedList

/**
 * Builder pattern class allowing you to construct a MenuAnimation made of multiple menu animations.
 * Alternatively you can use #buildList() to create a list of the animations instead of them being
 * consolidating into a single animation.
 *
 * @constructor Create empty Menu animations builder
 * @see com.runicrealms.menus.animation.MenuAnimation
 * @see com.runicrealms.menus.animation.MultiMenuAnimation
...
open class MenuAnimationsBuilder {
    ...
    /**
     * Apply these animations to a MenuBuilder. This simply sets the MenuBuilder's animations to
     * this builder's current animations.
     *
