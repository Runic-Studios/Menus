...
/**
 * An ItemStack wrapper for items inside custom menus. Contains a list of actions to execute on
 * click, and whether or not to allow players to move this icon freely (defaults to menu default).
 *
 * @property icon ItemStack icon representing this MenuItem
 * @param interactionsBlocked If specified (not null) overrides the menu default interactions
 *   blocked.
 * @constructor Create a MenuItem with no actions
 */
open class MenuItem
@JvmOverloads
constructor(val icon: ItemStack, interactionsBlocked: Boolean? = null) {
    ...
    /**
     * Whether or not to block interactions for this MenuItem. Wrapper of the internal value which
     * is nullable. This uses custom accessors so that it is exposed as a non null value.
     */
    var interactionsBlocked: Boolean
        get() =
            internalInteractionsBlocked
                ?: throw IllegalStateException(
                    "MenuItem#interactionsBlocked not overridden by MenuItem holder!"
                )
        set(value) {
            internalInteractionsBlocked = value
        }
    ...
    /**
     * If this menu item does not specify whether or not to allow players to move this item, this
     * allows this encompassing menu to overwrite the value.
     *
     * @param defaultInteractionsBlocked Menu default value
     */
    internal fun applyDefaultInteractionsBlocked(defaultInteractionsBlocked: Boolean) =
        internalInteractionsBlocked ?: run { interactionsBlocked = defaultInteractionsBlocked }
}
